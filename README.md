...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/agcs-designer
```

A live public deployment of this template is available at [https://agcs-designer.templates.workers.dev](https://agcs-designer.templates.workers.dev)
